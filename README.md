...
If you want to preprocess by yourself, the preprocessing code `code/preprocessing/preprocess_brats.py` is also provided, just download (`BRATS2020_Training_Data`)[https://www.kaggle.com/datasets/awsaf49/brats20-dataset-training-validation] in `datasets/BraTS` folder (Here `BRATS2020_Training_Data` may refer to `BRATS2020_Training_Data/MICCAI_BRATS2020_Training_Data`).
